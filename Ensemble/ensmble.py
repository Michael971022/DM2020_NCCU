# -*- coding: utf-8 -*-
"""
Created on Tue Jun 30 21:06:55 2020
...
for col in raw_data.columns:
    if raw_data[col].dtype == object and col != "Attrition":
        ...
        print("========================================================================")
    elif raw_data[col].dtype == 'int64' and col != "Attrition":
...
for train_index, test_index in kf.split(one_hot_encoding_df):
    ...
    model = RandomForestClassifier(DecisionTreeClassifier(max_depth=2, min_samples_split=20, min_samples_leaf=50), 
                               n_estimators=900, learning_rate=0.1)
    #model = AdaBoostClassifier(DecisionTreeClassifier(max_depth=20, min_samples_split=20, min_samples_leaf=50), 
    #                           algorithm="SAMME.R",n_estimators=600, learning_rate=0.8)
