...
from sklearn.naive_bayes import BernoulliNB # F1 44.6%
from sklearn.naive_bayes import ComplementNB # F1 28.7%
from sklearn.naive_bayes import MultinomialNB # F1 28.8%
...
for train_index, test_index in kf.split(one_hot_encoding_df):
    ...
    clf = BernoulliNB(fit_prior=True,alpha=0.2)
    #clf = ComplementNB(alpha=0.5)
    #clf = MultinomialNB(fit_prior=True,alpha=0.9)
